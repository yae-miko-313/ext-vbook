function execute(url) {
    ...
    if($.msg == "VIP章节请先登录。") {
        ...
        `Đây là chương VIP hoặc Bạn chưa đăng nhập hoặc mua chương<br>Vui lòng kiểm tra lại!<br> Link báo lỗi : https://wap.faloo.com/${url.replace("id=","").replace("&n=","_")}.html`
        )
