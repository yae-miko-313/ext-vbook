...
/**
 * Deterministic string hash (used if sharding is requested)
 */
...
/**
 * Final VBook Stable API (Legacy Compatibility)
 * Served as /api/vbook.json
 */
module.exports = async function handler(req, res) {
    ...
    try {
        ...
        // 1. Optional Sharding (Default to full list if total is not provided)
        let processedData = [];
        ...
        // 2. Clean Data for Stable Parser
        ...
        const responseData = {
            metadata: {
                author: "kychi",
                description: "VBook Aggregate Master Manifest (Stable Friendly)"
            },
            data: finalData
        };
        ...
        // CRITICAL: Force text/plain header for legacy stable app compatibility
        ...
        console.error('[API] vbook.json Error:', error);
