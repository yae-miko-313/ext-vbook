function execute(url) {
    ...
    console.log(book_id)
    let response = fetch("https://www.shencou.com/read/" + b_id + "/" + book_id +"/index.html");
    if (response.ok) {
        ...
        for (let i = 0;i < el.size(); i++) {
            ...
            data.push({
                ...
                url: "https://m.shencou.com/chapter.php?aid="+ book_id +"&cid=" + chapter_id,
                host: "https://www.shencou.com"
            })
        }
