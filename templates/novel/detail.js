...
function execute(url) {
    ...
    return Response.success({
        ...
        // Similar/related books — often rendered as a widget on the same page.
        suggests: [
        ...
        comments: [
            { title: "Bình luận", input: BASE_URL + "/comment?bookId=" + doc.select("SELECTOR_BOOK_ID").attr("value"), script: "comments.js" }
        ]
    });
}