...
function execute(url) {
    ...
    // TODO: Gợi ý — phim/video liên quan hoặc cùng tác giả/đạo diễn (tùy chọn)
    var suggests = [];
    ...
    var comments = [];
    var inputcomment = ""; // có thể là lấy ngay từ SELECTOR nào đó trên trang, hoặc API riêng nếu có
