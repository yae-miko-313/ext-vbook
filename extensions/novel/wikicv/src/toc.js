...
function execute(url) {
    ...
    var doc = Http.get(url).headers({"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/122.0.0.0 Safari/537.36","Referer": BASE_URL + "/","Origin": BASE_URL,"Accept-Language":"vi-VN,vi;q=0.9,en;q=0.8"}).html();
    ...
    function getChapterInPage(currentPage) {
        return Http.get(BASE_URL + "/book/index").headers({"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/122.0.0.0 Safari/537.36","Referer": BASE_URL + "/","Origin": BASE_URL,"Accept-Language":"vi-VN,vi;q=0.9,en;q=0.8"}).params({
            bookId: bookId,
            signKey: signKey,
